...
else
{
 	...
 	begin_table();
    begin_main_frame("Recover Lost Passwords");
	begin_frame();
	?><center>
    ...
    (You will have to reply to a confirmation email.)</p></center>
	<form method=post action=recover.php>
	<table border=1 cellspacing=0 cellpadding=10><center>
	<tr><td align="center" class=rowhead>Registered email</td>
