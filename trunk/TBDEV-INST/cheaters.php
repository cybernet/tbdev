...
print("<table border=0 width=\"100%\" cellspacing=0 cellpadding=0><tr><td align=right>$pagertop</td></tr></table><br />");
// end
...
print("<td class=\"tableb\" width=10 align=center valign=middle>#</td>
...
// will: added this for page links
print("<br /><table border=0 width=\"100%\" cellspacing=0 cellpadding=0><tr><td align=right>$pagertop</td></tr></table>");
// end
