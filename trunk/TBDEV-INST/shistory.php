<?php
//////////drykilllogics shoutbox ripped to shoutboxhistory by Bigjoos///////////////////////////
...
print("<center><font class=small>We currently have " . htmlspecialchars($count1) . " shouts on history</font></center>");
begin_main_frame();
