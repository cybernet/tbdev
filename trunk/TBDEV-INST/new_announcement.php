...
<h1>Create Announcement for <?php print($n_pms);?> user<?php print(($n_pms>1 ? 's': ''));?>!</h1>
<form name=compose method=post action=new_announcement.php>
<table border=1 cellspacing=0 cellpadding=5>
<tr>
<td colspan="2"><b>Subject: </b>
<input name="subject" type="text" size="76" value='<?php print(safe($subject));?>' ></td>
</tr>
...
<!--<textarea name=msg cols=80 rows=15><?php print(safe($body));?></textarea>-->
...
<?php print(safe($subject));?></h2></td></tr>
<tr><td class=text>
<?php
