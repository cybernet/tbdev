...
$res = mysql_query("SELECT COUNT(*) FROM users WHERE invites >'0'") or sqlerr();
...
print("<table border=0 class=invitesouter width=675 cellspacing=0 cellpadding=2>\n");
if ($count) {

print("<tr><td align=\"left\" colspan=\"8\">");
print($pagertop);
print("</td></tr>");
}
...
print("<tr><td align=left class=wtf><a href=userdetails.php?id=$arr[id]><b>$arr[username]</b></a></td>
