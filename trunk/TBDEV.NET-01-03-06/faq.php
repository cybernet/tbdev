...
<li><a href="#user"><b>User information</b></a>
  <ul>
	  ...
	  <li><a href="#user4" class="altlink">Can you delete my (confirmed) account?</a>
		<img src="<?=$pic_base_url?>updated.png" alt="Updated" width="46" height="11" align="absbottom"></li>
...
<li><a href="#up"><b>Uploading</b></a>
  <ul>
	...
	<img src="<?=$pic_base_url?>new.png" alt="New" width="27" height="11" align="absbottom"></li>
  </ul>
</li>
<br>
<li><a href="#dl"><b>Downloading</b></a>
  <ul>
    ...
    <li><a href="#dl5" class="altlink">Why do my downloads sometimes stall at 99%?</a></li>
 	  ...
 	  <img src="<?=$pic_base_url?>new.png" alt="New" width="27" height="11" align="absbottom">
...
<br>
Snapshots are available on the <a href=ftp://torrentbits.org/snapshots/ class=altlink>FTP</a>. Please note: We do not give any kind of support on the source code so please don't bug us about it. If it works, great, if not too bad. Use this software at your own risk!
<p>
Here is a nice tutorial on getting it all to work, written by one of our users: <a href=http://www.geocities.com/themisterofmisters/tbsourcetut-v0.1.txt>http://www.geocities.com/themisterofmisters/tbsourcetut-v0.1.txt</a>. Note: This tutorial is not supported by TB. Please direct all comments on the tutorial to the author, <b>MrMister</b>.
</td></tr></table>
</td></tr></table>
<br>
<br>
...
<tr>
	<td class=embedded bgcolor="#F5F4EA">&nbsp; <b><img src="<?=$pic_base_url?>star.gif" alt="Star"></td>
	<td class=embedded width=5>&nbsp;</td>
...
<br>
This section was written for TorrentBits, a closed, port 80-81 tracker. Other trackers may be open or closed, and many listen
