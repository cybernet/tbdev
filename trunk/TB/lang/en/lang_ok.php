...
'ok_email' => "A confirmation email has been sent to the address you specified (" . htmlentities($email, ENT_QUOTES) . "). You need to read and respond to this email before you can use your account. If you don't do this, the new account will be deleted automatically after a few days.",
...
'ok_account_active_login' => "<p>Your account has been activated! You have been automatically logged in. You can now continue to the <a href='{$TBDEV['baseurl']}/index.php'><b>main page</b></a> and start using your account.</p>\n",
'ok_read_rules' => "<p>Before you start using {$TBDEV['site_name']} we urge you to read the <a href='rules.php'><b>RULES</b></a> and the <a href='faq.php'><b>FAQ</b></a>.</p>\n",
