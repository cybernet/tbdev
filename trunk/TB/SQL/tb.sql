...
CREATE TABLE `avps` (
  `arg` varchar(20) character set utf8 collate utf8_unicode_ci NOT NULL default '',
  `value_s` text character set utf8 collate utf8_unicode_ci NOT NULL,
...
CREATE TABLE `comments` (
  ...
  `ori_text` text character set utf8 collate utf8_unicode_ci NOT NULL,
...
CREATE TABLE `countries` (
  ...
  `flagpic` varchar(50) character set utf8 collate utf8_unicode_ci default NULL,
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8;
...
CREATE TABLE `peers` (
  `id` int(10) unsigned NOT NULL auto_increment,
  `torrent` int(10) unsigned NOT NULL default '0',
  `passkey` varchar(32) character set utf8 collate utf8_unicode_ci NOT NULL,
  `peer_id` varchar(20) character set utf8 collate latin1_bin NOT NULL default '',
...
CREATE TABLE `polls` (
  ...
  `option0` varchar(40) character set utf8 collate utf8_unicode_ci NOT NULL default '',
  `option1` varchar(40) character set utf8 collate utf8_unicode_ci NOT NULL default '',
  `option2` varchar(40) character set utf8 collate utf8_unicode_ci NOT NULL default '',
  `option3` varchar(40) character set utf8 collate utf8_unicode_ci NOT NULL default '',
  `option4` varchar(40) character set utf8 collate utf8_unicode_ci NOT NULL default '',
  `option5` varchar(40) character set utf8 collate utf8_unicode_ci NOT NULL default '',
  `option6` varchar(40) character set utf8 collate utf8_unicode_ci NOT NULL default '',
  `option7` varchar(40) character set utf8 collate utf8_unicode_ci NOT NULL default '',
  `option8` varchar(40) character set utf8 collate utf8_unicode_ci NOT NULL default '',
  `option9` varchar(40) character set utf8 collate utf8_unicode_ci NOT NULL default '',
  `option10` varchar(40) character set utf8 collate utf8_unicode_ci NOT NULL default '',
  `option11` varchar(40) character set utf8 collate utf8_unicode_ci NOT NULL default '',
  `option12` varchar(40) character set utf8 collate utf8_unicode_ci NOT NULL default '',
  `option13` varchar(40) character set utf8 collate utf8_unicode_ci NOT NULL default '',
  `option14` varchar(40) character set utf8 collate utf8_unicode_ci NOT NULL default '',
  `option15` varchar(40) character set utf8 collate utf8_unicode_ci NOT NULL default '',
  `option16` varchar(40) character set utf8 collate utf8_unicode_ci NOT NULL default '',
  `option17` varchar(40) character set utf8 collate utf8_unicode_ci NOT NULL default '',
  `option18` varchar(40) character set utf8 collate utf8_unicode_ci NOT NULL default '',
  `option19` varchar(40) character set utf8 collate utf8_unicode_ci NOT NULL default '',
  `sort` enum('yes','no') character set utf8 collate utf8_unicode_ci NOT NULL default 'yes',
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8;
...
CREATE TABLE `topics` (
  `id` int(10) unsigned NOT NULL auto_increment,
  `userid` int(10) unsigned NOT NULL default '0',
  `subject` varchar(40) character set utf8 collate utf8_unicode_ci default NULL,
...
CREATE TABLE `torrents` (
  `id` int(10) unsigned NOT NULL auto_increment,
  `info_hash` varchar(20) character set utf8 collate latin1_bin NOT NULL default '',
  `name` varchar(255) character set utf8 collate utf8_unicode_ci NOT NULL default '',
  `filename` varchar(255) character set utf8 collate utf8_unicode_ci NOT NULL default '',
  `save_as` varchar(255) character set utf8 collate utf8_unicode_ci NOT NULL default '',
  ...
  `ori_descr` text character set utf8 collate utf8_unicode_ci NOT NULL,
  ...
  `nfo` text character set utf8 collate utf8_unicode_ci NOT NULL,
...
CREATE TABLE `users` (
  ...
  `passhash` varchar(32) character set utf8 collate utf8_unicode_ci NOT NULL default '',
  `secret` varchar(20) character set utf8 collate latin1_bin NOT NULL default '',
  `passkey` varchar(32) character set utf8 collate utf8_unicode_ci NOT NULL,
  `email` varchar(80) character set utf8 collate utf8_unicode_ci NOT NULL default '',
  `status` enum('pending','confirmed') character set utf8 collate utf8_unicode_ci NOT NULL default 'pending',
  `added` int(11) NOT NULL,
  `last_login` int(11) NOT NULL,
  `last_access` int(11) NOT NULL,
  `editsecret` varchar(20) character set utf8 collate latin1_bin NOT NULL default '',
  ...
  `notifs` varchar(100) character set utf8 collate utf8_unicode_ci NOT NULL default '',
  `modcomment` text character set utf8 collate utf8_unicode_ci NOT NULL,
