...
//loggedinorreturn();
   ...
   $HTMLOUT .= begin_frame("General rules - <font color='#004E98'>Breaking these rules can and will get you banned!</font>");
   $HTMLOUT .= "<ul>
    ...
    $HTMLOUT .= begin_frame("Downloading rules - <font color='#004E98'>By not following these rules you will lose download privileges!</font>");
    $HTMLOUT .= "<ul>
    ...
    $HTMLOUT .= begin_frame("General Forum Guidelines - <font color='#004E98'>Please follow these guidelines or else you might end up with a warning!</font>");
    $HTMLOUT .= "<ul>
    ...
    $HTMLOUT .= begin_frame("Avatar Guidelines - <font color='#004E98'>Please try to follow these guidelines</font>");
    $HTMLOUT .= "<ul>
    ...
    if ($CURUSER['class'] >= UC_UPLOADER) 
    {
      ...
      $HTMLOUT .= begin_frame("Uploading rules - <font color='#004E98'>Torrents violating these rules may be deleted without notice</font>");
      $HTMLOUT .= "<ul>
    ...
    if ($CURUSER['class'] >= UC_MODERATOR) 
    {
     ...
     $HTMLOUT .= begin_frame("Moderating rules - <font color='#004E98'>Whom to promote and why</font>");
     $HTMLOUT .= "<br />
      ...
      $HTMLOUT .= end_frame();
      $HTMLOUT .= begin_frame("Moderating Rules - <font color='#004E98'>Use your better judgement!</font>");
      ...
      $HTMLOUT .= end_frame();
      $HTMLOUT .= begin_frame("Moderating options - <font color='#004E98'>What are my privileges as a mod?</font>");
    ...
    print stdhead("Rules") . $HTMLOUT . stdfoot(); 
?>