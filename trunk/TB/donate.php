...
dbconn();
    ...
    <input src='https://www.paypal.com/en_US/i/btn/x-click-butcc-donate.gif' name='submit' alt='Make payments with PayPal - it's fast, free and secure!' type='image' />
...
<p>Thank You For Using Our Software!</p>
    ...
    $HTMLOUT .= "<b>After you have donated -- make sure to <a href='sendmessage.php?receiver=1'>send us</a> the <font color='red'>transaction id</font> so we can credit your account!</b>";
