...
function add_link($url, $title, $description = "")
{
  ...
  return "<li>$text</li>\n";
    ...
    if ($CURUSER) 
    { 
      $HTMLOUT .= "<p><a href='sendmessage.php?receiver=1'>Please report dead links!</a></p>";
    }
    
    $HTMLOUT .= "<table width='750' class='main' border='0' cellspacing='0' cellpadding='0'><tr><td class='embedded'>";

    $HTMLOUT .= "<h2>Other pages on this site</h2>
    ...
    $HTMLOUT .= "<h2>BitTorrent Information</h2>
    <table width='100%' border='1' cellspacing='0' cellpadding='10'><tr><td class='text'><ul>
    ...
    $HTMLOUT .= "<h2>BitTorrent Software</h2>
    <table width='100%' border='1' cellspacing='0' cellpadding='10'><tr><td class='text'><ul>
    ...
    $HTMLOUT .= "<h2>Forum communities</h2>
    <table width='100%' border='1' cellspacing='0' cellpadding='10'><tr><td class='text'><ul>
    ...
    $HTMLOUT .= "<h2>Link to TBDev.net</h2>
