...
function get_user_class_color($class)
{
    switch ($class)
    {
        ...
        case UC_POWER_USER: return "6464FF";
        case UC_VIP: return "009F00";
        case UC_UPLOADER: return "00eaff";
        case UC_MODERATOR: return "a3ffbd";
        case UC_ADMINISTRATOR: return "f3ffa3";
        case UC_SYSOP: return "736cff";
    }
    return "";
}
