...
function maketable($res)
    ...
    if ($user["downloaded"] > 0)
    {
      ...
      $sr = "<table align='left' border='0' cellspacing='0' cellpadding='0'><tr><td class='embedded'><font color='" . get_ratio_color($sr) . "'>" . number_format($sr, 3) . "</font></td><td class='embedded'>&nbsp;&nbsp;<img src=\"{$TBDEV['pic_base_url']}smilies/{$s}.gif\" alt='' /></td></tr></table>";
    ...
    if ($CURUSER['class'] >= UC_MODERATOR && $user["class"] < $CURUSER['class'])
    {
      ...
      // forum shit
      $HTMLOUT.="<tr>
      <td class='rowhead'>Forum Mod</td><td colspan='2' align='left'>
      <input name=\"forum_mod\" value=\"yes\" type=\"radio\" " .
    ...
    if ($user["forum_mod"] == "yes") 
    {
      ...
      {
        $HTMLOUT.="<tr>
        <td style='border-width: 1px 0px 0px 0px;border-style:dotted;' width='100%'><a href='{$TBDEV['baseurl']}/forums.php?action=viewforum&forumid=".$a["id"]."'>".$a["name"]."</a><br />
