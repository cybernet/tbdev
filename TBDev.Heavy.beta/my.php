...
loggedinorreturn();
    ...
    ****************/
    ...
    $HTMLOUT .= "<fieldset>
    <legend><strong>{$lang['my_delete_pms']}</strong></legend>
    <label><input type='checkbox' name='deletepms'" . ($CURUSER["deletepms"] == "yes" ? " checked='checked'" : "") . " /> {$lang['my_default_delete']}</label>
    </fieldset>
    <fieldset>
    <legend><strong>{$lang['my_save_pms']}</strong></legend>
    <label><input type='checkbox' name='savepms'" . ($CURUSER["savepms"] == "yes" ? " checked='checked'" : "") . " /> {$lang['my_default_save']}</label>
    </fieldset>
    
    <fieldset>
    <legend><strong>Forum Subscribe Pm</strong></legend>
    <label><input type='radio' name='subscription_pm' " . ($CURUSER["subscription_pm"] == "yes" ? " checked='checked'" : "") . " value='yes' />yes </label>
    <label><input type='radio' name='subscription_pm' " . ($CURUSER["subscription_pm"] == "no" ? " checked='checked'" : "") . " value='no' />no<br /> When someone posts in a subscribed thread, you will be PMed.</label></fieldset>";
