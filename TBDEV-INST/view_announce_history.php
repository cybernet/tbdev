...
// Remember to change the following line to match your server
...
<tr>
<td width="50%" bgcolor="orange">Subject: <b><?php print(safe($subject));?></b></td>
</tr>
<tr>
<td colspan="2" bgcolor="white"><?php print(format_comment($body));?></td>
</tr>
<tr>
<td>
<a href='<?php print($_SERVER['PHP_SELF']);?>'>Back</a>
</td>
</tr>
</table>
<?php
...
foreach($ann_list AS $x)
print('<tr><td align=center><a href=?action=read_announce&id='.
$x[0].'>'.safe($x[1]).'</a></td></tr>'."\n");
?></tr></td>
</table>
<?php
end_table();
