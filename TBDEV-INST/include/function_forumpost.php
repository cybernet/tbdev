...
?><table align="center" width="760" cellspacing=0 cellpadding=8><tr><td align="left" class=colhead><b>Topic</b></td><!--<td align="center" class=colhead><b>Author</b></td><td align="center" class=colhead><b>Replies</b></td>--><td align="center" class=colhead><b>Views</b></td><td align="center" class=colhead><b>Last Post</b></td><!--<td align="center" class=colhead><b>Posted At</b></td>-->
</tr>
<?php
$page = 1;
$num = 0;
/// HERE GOES THE QUERY TO RETRIEVE DATA FROM THE DATABASE AND WE START LOOPING ///
$topicres = mysql_query("SELECT t.id, t.userid, t.subject, t.locked, t.forumid, t.pollid, t.lastpost, t.sticky, t.views, t.forumid, f.minclassread, f.name ".
...
?><tr><td><?=$subject;?></td><td align="center"><?=number_format($topicarr["views"]);?></td><td align="center"><?=$username;?></td></tr><?php
}
?></table><p></p>
<?php
}
