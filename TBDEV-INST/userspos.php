...
case '2': $column = 'last_access'; break;
case '3': $column = 'class'; break;
case '4': $column = 'downloadpos'; break;
case '5': $column = 'uploadpos'; break;
case '6': $column = 'forumpost'; break;
case '7': $column = 'ttablehl'; break;
case '8': $column = 'invite_on'; break;
case '9': $column = 'tohp'; break;
case '10': $column = 'imagecats'; break;
case '11': $column = 'tenpercent'; break;
case '12': $column = 'chatpost'; break;
case '13': $column = 'seedbonus'; break;
default: $column = 'username'; break;
}
...
<tr align=center>
<td class=colhead width='1%'><a href="userspos.php?<?=$oldlink;?>sort=1&type=<?=$link1;?>" title="Order by">Username</a></td>
<td class=colhead width='1%'><a href="userspos.php?<?=$oldlink;?>sort=2&type=<?=$link2;?>" title="Order by">Last&nbsp;seen</a></td>
<td class=colhead width='1%'><a href="userspos.php?<?=$oldlink;?>sort=3&type=<?=$link3;?>" title="Order by">Class</a></td>
<td class=colhead width='1%'><a href="userspos.php?<?=$oldlink;?>sort=4&type=<?=$link4;?>" title="Order by">Download</a></td>
<td class=colhead width='1%'><a href="userspos.php?<?=$oldlink;?>sort=5&type=<?=$link5;?>" title="Order by">Upload</a></td>
<td class=colhead width='1%'><a href="userspos.php?<?=$oldlink;?>sort=6&type=<?=$link6;?>" title="Order by">Post</a></td>
<td class=colhead width='1%'><a href="userspos.php?<?=$oldlink;?>sort=7&type=<?=$link7;?>" title="Order by">Highlight</a></td>
<td class=colhead width='1%'><a href="userspos.php?<?=$oldlink;?>sort=8&type=<?=$link8;?>" title="Order by">Invite</a></td>
<td class=colhead width='1%'><a href="userspos.php?<?=$oldlink;?>sort=9&type=<?=$link9;?>" title="Order by">Torrent Marquee</a></td>
<td class=colhead width='1%'><a href="userspos.php?<?=$oldlink;?>sort=10&type=<?=$link10;?>" title="Order by">Image cats</a></td>
<td class=colhead width='1%'><a href="userspos.php?<?=$oldlink;?>sort=11&type=<?=$link11;?>" title="Order by">10 %</a></td>
<td class=colhead width='1%'><a href="userspos.php?<?=$oldlink;?>sort=12&type=<?=$link12;?>" title="Order by">Shout</a></td>
<td class=colhead width='1%'><a href="userspos.php?<?=$oldlink;?>sort=13&type=<?=$link13;?>" title="Order by">SeedBonus</a></td>
</tr>
<?
for ($i = 1; $i <= $num; $i++){
