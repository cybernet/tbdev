...
echo "<div class=faqhead align=left>&nbsp;<img onclick=\"javascript:flipBox('".$arr['id']."')\" src='pic/panel_off.gif' name='b_".$arr['id']."' style='vertical-align:middle;' />&nbsp;<a class=altlink href=\"#\" onclick=\"javascript:flipBox('".$arr['id']."')\" src='pic/panel_off.gif' name='b_".$arr['id']."'>". $arr['heading']. $updated. "</a></div>".
"<div align='left' id='box_".$arr['id']."' style='display:block' class='faqbody'><p>". format_comment($arr['body']) . "</p></div>";
//}//===end class filter
