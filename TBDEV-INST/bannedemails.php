...
print("<tr><td class=colhead>Added</td><td class=colhead align=left>Email</td>".
...
"</a></td><td align=left>$arr[comment]</td><td><a href=bannedemails.php?remove=$arr[id]>Remove</a></td></tr>\n");
}
print("</table>\n");
}
