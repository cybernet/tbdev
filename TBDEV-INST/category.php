...
stderr("Err","Maybe come back later!");
...
if ($add)
stderr("Succes","New category added, go <a href=\"".$BASEURL."/category.php\">back</a> and add more!");
}//end action add
...
if ($edit)
stderr("Succes","Category successfully edited! Go <a href=\"".$BASEURL."/category.php\">back</a>");
}//end action edit
...
stderr("Succes","Category successfully deleted! Go <a href=\"".$BASEURL."/category.php\">back</a>");
}
}
else
...
begin_frame("Categories<br/><font class=\"small\" color=red>Remember to cache your catergories after you finish editing them from <a href=\"category.php?action=cache\">here</a>");
...
{
$edit = "<a href=\"category.php?action=edit&amp;cid=".$arr["id"]."\"><img src=\"pic/edit.png\" title=\"Edit Category\" style=\"border:none;padding:3px;\" /></a>";
$delete = "<a href=\"category.php?action=delete&amp;cid=".$arr["id"]."\"><img src=\"pic/drop.png\" title=\"Drop Category\" style=\"border:none;padding:3px;\" /></a>";
print("<tr>");
