...
<td class=tabletorrent align=center width="1%">Id</td>
<td class=tabletorrent align=center width="1%">HitRun Level</td>
<td class=tabletorrent align=center width="1%">Pre-Warn</td>
...
'<td align=center><b>' . ($row['hit_run']) . '</b></td>'.
'<td align=center><b>' . ($row['prewarn']) . '</b></td>'.
