...
print("</td></tr></table>\n");
print("<br /><br />");
print("<h2 align=left><a name=\"pending\">Pending Friends list</a></h2>\n");
...
print("<h2 align=left><a name=\"friendreqs\">Friends awaiting confirmation</a></h2></td></tr>");
print("<tr><td style='padding: 10px;background-color: '>");
print("$friendreqs\n");
print("</td></tr></table>\n");
