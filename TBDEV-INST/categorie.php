...
if ($edit)
stderr("Succes","Category successfully edited! Go <a href=\"".$BASEUL."/category.php\">back</a>");
}//end action edit
...
stderr("Succes","Category successfully deleted! Go <a href=\"".$BASEUL."/category.php\">back</a>");
}
}
else
...
$delete = "<a href=\"category.php?action=delete&amp;cid=".$arr["id"]."\"><img src=\"pic/del.png\" title=\"Drop Category\" style=\"border:none;padding:3px;\" /></a>";
print("<tr>");
