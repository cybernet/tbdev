...
//sql
$userpaa = mysql_query("SELECT * FROM users WHERE passkey = '$passkey'") or die(mysql_error());
...
$res2 = mysql_query("SELECT name, category FROM torrents WHERE id=$id") or sqlerr(__FILE__, __LINE__);
