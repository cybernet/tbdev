...
?>
<tr>
  <td align="center" class="bottom" colspan="3"><h4>Historical IP addresses used by <a href=userdetails.php?id='.$userid.'><b><?=$username; ?></b></a></h4></td>
</tr>
<? $ipcount = mysql_num_rows($resip); ?>
<tr>
  <td align="center" class="bottom" colspan="3">Total Unique IP Addresses User Has Loged In With <?=$ipcount; ?></td>
</tr>
<tr>
...
<? while ($iphistory = mysql_fetch_array($resip)){
   $host = gethostbyaddr($iphistory['ip']);
?>
<tr>
<td align="center"><?=$iphistory['access']; ?></td>
<td align="center"><?=$iphistory['ip']; ?></td>
