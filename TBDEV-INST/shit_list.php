...
echo'<h1><img src=pic/smilies/shit.gif>Add '.$arr_name['username'].' to your Shit List<img src=pic/smilies/shit.gif></h1><form method=post action=?action=add><p><table><tr><td class=colhead colspan=2>new</td></tr>'.
...
'<img src=pic/smilies/shit.gif><img src=pic/smilies/shit.gif><img src=pic/smilies/shit.gif><img src=pic/smilies/shit.gif><img src=pic/smilies/shit.gif><img src=pic/smilies/shit.gif><img src=pic/smilies/shit.gif>'.
...
'<input type=hidden name=shit_list_id value='.$shit_list_id.'><input type=hidden name=return_to value='.$return_to.'>'.
'<tr><td align=center colspan=2><input class=button type=submit value="add this shit bag!"></td></tr></form></table>';
...
echo $message.'<br><table width=750 border=0 cellspacing=0 cellpadding=0><tr><td class=colhead align=center valigh=top><h1>Shit List for '.$CURUSER['username'].'</h1>'.
'<img src=pic/smilies/shit.gif alt=shit> shittiest at the top <img src=pic/smilies/shit.gif alt=shit></td></tr>'.
'<tr><td class=embedded><table width=750 border=1 cellspacing=0 cellpadding=5><tr><td>';
...
get_user_icons($shit_list).'<b> [ '.$class_name.' ]</b> '.$shit.'<br><b>joined:</b> '.$shit_list['added'].' [ '.get_elapsed_time(sql_timestamp_to_unix_timestamp($shit_list['added'])).' ago ]'.
'<br><b>added to shit list:</b> '.$shit_list['shit_list_added'].' [ '.get_elapsed_time(sql_timestamp_to_unix_timestamp($shit_list['shit_list_added'])).' ago ]<br>'.
'<b>last seen:</b> '.get_date_time($shit_list['last_access']).' [ '.get_elapsed_time(sql_timestamp_to_unix_timestamp($shit_list['last_access'])).' ago ]<hr>'.format_comment($shit_list['text']);

$buttons ='<br><a class=altlink href=?action=delete&shit_list_id='.$shit_list['id'].'>remove</a>'.
'<br><br><a class=altlink href=sendmessage.php?receiver='.$shit_list['id'].'>PM</a>';
...
($avatar ? '<img width=80px src='.$avatar.'>' : '').'</td><td><table width=420 hight=100%><tr><td class=embedded>'.$main.'</td>'.
'<td class=embedded valign=top align=center>'.$buttons.'</td></tr></table></td></tr></td></tr></table>';
...
echo(($i % 2 == 1) ? '<td width=50%>&nbsp;</td></tr></table>' : '').$shit_list.'</td></tr></table>'.
