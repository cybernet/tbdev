...
stderr("Error", "Method");
  ...
  {               																							//////  PM  ///
	  ...
	  $res = mysql_query("SELECT acceptpms, parked, email, notifs, UNIX_TIMESTAMP(last_access) as la FROM users WHERE id=$receiver") or sqlerr(__FILE__, __LINE__);
...
EOD;
     ...
     if ($returnto)
    {
    if ($returnto == 'http://www.yoursite.com/shoutbox.php')
    {
