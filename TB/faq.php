...
dbconn(false);
    ...
    <tr>
      ...
      <table width='100%' border='1' cellspacing='0' cellpadding='10'>
        <tr>
          <td class='text'>
          <b>Welcome to {$TBDEV['site_name']}!</b><br />
    <br />
    ...
    Before you do anything here at {$TBDEV['site_name']} we suggest you read the <a class='altlink' href='rules.php'>rules</a>!
    There are only a few rules to abide by, but we do enforce them!<br />
    <br />
    Before you go any further you should read the {$TBDEV['site_name']} <a class='altlink' href='useragreement.php'>user agreement</a>.
    <br />
    </td></tr></table>
    </td></tr></table>
    <br />
    ...
    $HTMLOUT .= "<a href='#user'><b>User information</b></a>
      <ul>
        ...
        <img src='{$TBDEV['pic_base_url']}updated.png' alt='Updated' width='46' height='11' /></li>
    ...
    $HTMLOUT .= "<a href='#stats'><b>Stats</b></a>
      <ul>
    ...
    $HTMLOUT .= "<a href='#up'><b>Uploading</b></a>
      <ul>
    ...
    $HTMLOUT .= "<a href='#dl'><b>Downloading</b></a>
      <ul>
    ...
    $HTMLOUT .= "<a href='#dlsp'><b>How can I improve my download speed?</b></a>
      <ul>
    ...
    $HTMLOUT .= "<a href='#prox'><b>My ISP uses a transparent proxy. What should I do?</b></a>
      <ul>
    ...
    $HTMLOUT .= "<a href='#conn'><b>Why can't I connect? Is the site blocking me?</b></a>
      <ul>
    ...
    $HTMLOUT .= "<a href='#other'><b>What if I can't find the answer to my problem here?</b></a>
    </td></tr></table>
    </td></tr></table>
    <br />
    <br />";
    ...
    <br />
    {$TBDEV['site_name']} is situated on a dedicated server in the Netherlands.
    ...
    $HTMLOUT .= "<b>How does this promotion thing work anyway?</b><a name='usera' id='usera'></a><br />
    <br />
    <table cellspacing='3' cellpadding='0'>
    <tr>
    ...
    * TorrentStorm.<br />
    ...
    <br />
    <b>1.</b> <i>You are the single {$TBDEV['site_name']} users in the LAN</i><br />
    <br />
    You should use the same {$TBDEV['site_name']} account in all the computers.<br />
    <br />
    ...
    <br />
    <br />
    <b>2.</b> <i>There are multiple {$TBDEV['site_name']} users in the LAN</i><br />
    <br />
    At present there is no way of making this setup always work properly with {$TBDEV['site_name']}.
    ...
    * you'll be able to seed, or make sure are well-seeded, for at least 24 hours.<br />
    ...
    be unable to connect with us. This generates a lot of frustration and bad-will against us at {$TBDEV['site_name']},
    ...
    if ($CURUSER)
    {
      ...
      $HTMLOUT .= "In <a class='altlink' href='userdetails.php?id={$CURUSER['id']}'>your</a> particular case, ";
      ...
      if (isset($wait))
      {
        ...
        $HTMLOUT .= "you will experience no delay.";
      $HTMLOUT .= "<br /><br />";
    }
    

    $HTMLOUT .= "This applies to new users as well, so opening a new account will not help. Note also that this
    ...
    <br />
    {$TBDEV['site_name']} does not allow clients to use ports commonly associated with p2p protocols.
    ...
    $HTMLOUT .= "<b>What's this 'IOError - [Errno13] Permission denied' error?</b><a name='dla'></a><br />
    <br />
    ...
    <br />
    The {$TBDEV['site_name']} tracker is quite smart at finding your real IP, but it does need the proxy to send the HTTP header
    ...
    thing to try should be connecting to {$TBDEV['baseurl']}:81. Note that even if this works your bt client will still try
    ...
    <ul>
      ...
      the list followed by your IP then everything should be ok, otherwise choose another proxy and try again.<br /></li>
        ...
        <li>Visit {$TBDEV['site_name']}. Hopefully the tracker will now pickup your real IP (check your profile to make sure).</li>
    </ul>
    <br />
    ...
    <br />
    This section was written for {$TBDEV['site_name']}, a closed, port 80-81 tracker. Other trackers may be open or closed, and many listen
    ...
    $HTMLOUT .= "<b>Alternate port (81)</b><a name='conn4'></a><br />
    <br />
    ...
    and replacing the announce url {$TBDEV['baseurl']}:81 with {$TBDEV['site_name']}:80 or just {$TBDEV['site_name']}.<br />
    <br />
    ...
    <p align='right'><font size='1' color='#004E98'><b>FAQ edited  by pdq at 2009-06-23 (22:26 GMT)</b></font></p>
    </td></tr></table>";
