...
require_once "include/user_functions.php";
    ...
    else
    {
      ...
      $HTMLOUT .= "<tr>
        <td class='colhead'>Added</td><td class='colhead' align='left'>First IP</td>
      ...
      while ($arr = mysql_fetch_assoc($res))
      {
        ...
        $HTMLOUT .= "<tr>
          ...
          <td><a href='admin.php?action=bans&amp;remove={$arr['id']}'>Remove</a></td>
         </tr>\n";
      }
    ...
    if ($CURUSER['class'] >= UC_ADMINISTRATOR)
    {
      ...
      <table border='1' cellspacing='0' cellpadding='5'>
        ...
        <tr>
          <td class='rowhead'>Comment</td><td><input type='text' name='comment' size='40' /></td>
        </tr>
        <tr>
          <td colspan='2' align='center'><input type='submit' name='okay' value='Add' class='btn' /></td>
        </tr>
        <tr>
          <td colspan='2' align='center'><input type='submit' name='cacheit' value='Cache' class='btn' /></td>
        </tr>
      </table>
      </form>";
    ...
    print stdhead("Bans") . $HTMLOUT . stdfoot();
