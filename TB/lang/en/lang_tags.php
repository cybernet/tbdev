...
'tags_tags' => "Tags",
'tags_title' => "<p>The {$TBDEV['site_name']} forums supports a number of <i>BB tags</i> which you can embed to modify how your posts are displayed.</p>",
...
'tags_image4' => "[img=".$TBDEV['baseurl']."/pic/logo.gif]",
...
'tags_image9' => "[img]".$TBDEV['baseurl']."/pic/logo.gif[/img]",
